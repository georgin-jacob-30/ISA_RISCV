...
module alu_control(
   ...
   parameter [3:0] FUNC_ADD      = 5'b00000;
   parameter [3:0] FUNC_SUB      = 5'b10000;
   parameter [3:0] FUNC_AND      = 5'b00111;
   parameter [3:0] FUNC_OR       = 5'b00110;
   parameter [3:0] FUNC_SLT      = 5'b00010;
   parameter [3:0] FUNC_SLL      = 5'b00001;
   parameter [3:0] FUNC_SRL      = 5'b00101;
   parameter [3:0] FUNC_MULT     = 5'b01000;
